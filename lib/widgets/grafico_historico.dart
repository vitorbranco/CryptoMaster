...
class _GraficoHistoricoState extends State<GraficoHistorico> {
  List<Color> cores = [
    Color.fromARGB(255, 114, 63, 180),
  ];
  Gradient gradiente = LinearGradient(
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
    colors: [
    Color.fromARGB(255, 114, 63, 180).withOpacity(0.35),
    Color.fromARGB(255, 114, 63, 180).withOpacity(0.05),
  ],
  );
    ...
    return LineChartData(
      ...
      lineBarsData: [
        LineChartBarData(
          ...
          isCurved: true,
          curveSmoothness: 0.5,
          color: Color.fromARGB(255, 114, 63, 180),
          barWidth: 1.5,
          dotData: FlDotData(show: false),
          belowBarData: BarAreaData(
            show: true,
            gradient: gradiente,
            // color: Color.fromARGB(255, 114, 63, 180).withOpacity(0.15),
          ),
        ),
      ],
